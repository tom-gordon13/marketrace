...
urlpatterns = [
    ...
    path('bucket/<int:bucket_id>/stock_inst_create_bucket', views.stock_inst_create_bucket, name='stock_inst_create_bucket'),
    path('stockinst/<int:stock_id>/delete/', views.stock_inst_delete, name="stock_inst_delete"),
]